        ...
        <div style={{ maxWidth:"640px", margin:"0 auto" }}>
          <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            ...
            <div style={{ display:"flex", gap:"6px", alignItems:"center" }}>
              ...
              <button onClick={() => setShowForge(true)} style={{ background:getForgeTasks().some(t => t.status === "pending")?"rgba(99,102,241,0.1)":"var(--surface2)", border:"1px solid "+( getForgeTasks().some(t => t.status === "pending") ? "rgba(99,102,241,0.4)" : "var(--border)"), borderRadius:"8px", padding:"7px", cursor:"pointer", color:getForgeTasks().some(t => t.status === "pending") ? "#6366f1" : "var(--text2)", display:"flex", alignItems:"center", position:"relative" }}><IconForge /></button>
